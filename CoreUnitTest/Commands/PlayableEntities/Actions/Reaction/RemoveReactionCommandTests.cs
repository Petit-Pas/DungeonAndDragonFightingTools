...
[TestFixture]
public class RemoveReactionCommandTests
{
    ...
    {
        // Arrange
        var command = new RemoveReactionCommand(_character.DisplayName);
    ...
    [Test]
    [Order(3)]
    public void Undo_Should_Reset_Reaction()
    {
        // Arrange
        var command = new RemoveReactionCommand(_character.DisplayName);
        _character.HasReaction = true;
    ...
    [Test]
    [Order(1)]
    public void Should_Not_Do_Anything_When_Reaction_Is_Already_Unavailable()
    {
        // Arrange
        var command = new RemoveReactionCommand(_character.DisplayName);
    ...
    [Test]
    [Order(2)]
    public void Should_Return_Canceled_When_Reaction_Is_Already_Unavailable()
    {
        // Arrange
        var command = new RemoveReactionCommand(_character.DisplayName);
        _character.HasReaction = false;
    ...
    [Test]
    [Order(3)]
    public void Undo_Should_Not_Change_Anything_When_Reaction_Was_Already_Unavailable()
    {
        // Arrange
        var command = new RemoveReactionCommand(_character.DisplayName);
        _character.HasReaction = false;
