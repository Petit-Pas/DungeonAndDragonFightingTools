...
[TestFixture]
public class RemoveBonusActionCommandTests
{
    ...
    [Test]
    [Order(1)]
    public void Should_Remove_Bonus_Action()
    {
        // Arrange
        var command = new RemoveBonusActionCommand(_character.DisplayName);
    ...
    [Test]
    [Order(3)]
    public void Undo_Should_Reset_Bonus_Action()
    {
        // Arrange
        var command = new RemoveBonusActionCommand(_character.DisplayName);
        _character.HasBonusAction = true;
    ...
    [Test]
    [Order(1)]
    public void Should_Not_Do_Anything_When_Bonus_Action_Is_Already_Unavailable()
    {
        // Arrange
        var command = new RemoveBonusActionCommand(_character.DisplayName);
    ...
    [Test]
    [Order(2)]
    public void Should_Return_Canceled_When_Bonus_Action_Is_Already_Unavailable()
    {
        // Arrange
        var command = new RemoveBonusActionCommand(_character.DisplayName);
        _character.HasBonusAction = false;
    ...
    [Test]
    [Order(3)]
    public void Undo_Should_Not_Change_Anything_When_Bonus_Action_Was_Already_Unavailable()
    {
        // Arrange
        var command = new RemoveBonusActionCommand(_character.DisplayName);
        _character.HasBonusAction = false;
