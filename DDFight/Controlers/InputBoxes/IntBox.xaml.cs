...
namespace DDFight.Controlers.InputBoxes
{
    ...
    /// </summary>
    public partial class IntBox : UserControl, IFocusable, IValidable
    {
        /// <summary>
        ///     Ctor
        /// </summary>
        ...
        public static readonly DependencyProperty IntegerProperty = DependencyProperty.Register(
            "Integer", typeof(int), typeof(IntBox),
        ...
        public bool IsValid()
        {
            return !Validation.GetHasError(IntBoxControl);
        }
